...
* @returns {BigInt}
*/
__exports.generate_seed = function() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.generate_seed(retptr);
...
* @returns {string}
*/
__exports.generate_maze = function(width, height, seed, format) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.generate_maze(retptr, width, height, low0, high0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
