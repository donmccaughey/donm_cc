    ...
    with Directory('macos_packages'):
        with Page('macOS Packages', name='index') as page:
            ...
            package(
                name='nginx',
                version='1.20.2',
                package='https://github.com/donmccaughey/nginx_pkg/releases/download/v1.22.0-r1/nginx-1.22.0.pkg',
            ...
            package(
                name='tree',
                version='2.0.2',
                package='https://github.com/donmccaughey/tree_pkg/releases/download/v2.0.2-r1/tree-2.0.2.pkg',
            ...
            package(
                name='XZ Utils',
                version='5.2.5',
                package='https://github.com/donmccaughey/xz_pkg/releases/download/v5.2.5-r2/xz-5.2.5-r2.pkg',
