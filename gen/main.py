...
with root:
    ...
    with IndexPage('Business Novels'):
        ...
        with Section(class_names=['links']):
            H1('Recommended')
            book('The Goal', 'https://www.amazon.com/Goal-Process-Ongoing-Improvement-ebook/dp/B002LHRM2O', checked=True)
            book('The Phoenix Project', 'https://www.amazon.com/Phoenix-Project-DevOps-Helping-Business-ebook/dp/B078Y98RG8', checked=True)
            book('The Unicorn Project', 'https://www.amazon.com/Unicorn-Project-Developers-Disruption-Thriving-ebook/dp/B07QT9QR41', checked=True)
            book('The Ideal Team Player', 'https://www.amazon.com/Ideal-Team-Player-Recognize-Cultivate-ebook/dp/B01B6AEJJ0', checked=True)
        ...
        with Section(class_names=['links']):
            H1('Business Comics')
            book('The Adventures of Johnny Bunko', 'https://www.amazon.com/Adventures-Johnny-Bunko-Career-Guide-ebook/dp/B0015DRPL8', checked=True)
            book("What Got You Here Won't Get You There", 'https://www.amazon.com/What-Here-There-illustrated-version-ebook/dp/B00710YFJY', checked=True)
    ...
    with IndexPage('Science Fiction'):
        ...
        with Page('James SA Corey'):
            ...
            with Section(class_names=['links']):
                ...
                book("Babylon's Ashes", 'https://www.amazon.com/gp/product/B018S2773Y', date='2016')
                book('Strange Dogs (novella)', 'https://www.amazon.com/gp/product/B06ZZ1MKW8', date='2017')
        ...
        with Page('Lois McMaster Bujold'):
            with Section(class_names=['overview']):
                ...
                """)
                P("""
                    The bibliography below is in internal chronological order.
                """)
            with Section(class_names=['links']):
